...
urlpatterns = [
    ...
    path('settings/email/', allauth_views.EmailView.as_view(), name='account_email'),
    path('settings/password/', allauth_views.PasswordChangeView.as_view(), name='account_change_password')
]